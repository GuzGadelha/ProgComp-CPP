...
// "cout << left" Configura o texto para ser alinhado à esquerda na largura especificada.
// "cout << right" Configura o texto para ser alinhado à direita na largura especificada.
// ".width(x)" Defina uma largura para uma célula